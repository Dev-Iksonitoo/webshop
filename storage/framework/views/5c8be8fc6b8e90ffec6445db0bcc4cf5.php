...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_seller" id="is_seller" <?php echo e(old('is_seller') ? 'checked' : ''); ?>>
                ...
                <div class="card-footer text-center">
                    <p>უკვე გაქვთ ანგარიში? <a href="<?php echo e(route('login')); ?>">შესვლა</a></p>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\ტრეა\weed-store\resources\views/auth/register.blade.php ENDPATH**/ ?>